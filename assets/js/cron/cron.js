...
const fitbitDataCollectionJob = new cron.CronJob('45 10 * * *', async () => {
...
const emailSendingJob = new cron.CronJob('45 10 * * *', async () => {
...
const smsSendingJob = new cron.CronJob('45 10 * * *', async () => {
