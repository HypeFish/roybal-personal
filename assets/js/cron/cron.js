...
const fitbitDataCollectionJob = new cron.CronJob('0 8 * * *', async () => {
...
const emailSendingJob = new cron.CronJob('12 10 * * *', async () => {
...
const smsSendingJob = new cron.CronJob('29 9 * * *', async () => {
